...
vpath %.c mss
vpath %.c common
vpath %.c common/modules/utilities
...
mssDemo: R4F_CFLAGS += --cmd_file=$(BUILD_CONFIGPKG)/compiler.opt --c99 -d$(TRACKOPT) -d_LITTLE_ENDIAN -icommon -imss/gtrack
