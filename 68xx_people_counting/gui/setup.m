...
handles.angle = 0;
handles.cfg = struct('filename', '../chirp_configs/mmw_pplcount_demo_default.cfg', 'loaded', 0);
handles.subzone = [];
...
if(hObject.Value)
     % Get Chirp Config File
     handles.cfg.filename = '../chirp_configs/mmw_pplcount_demo_default.cfg';
     guidata(hObject,handles)
end
